...
parcelRegister("juBn0", function(module, exports) {

$parcel$export(module.exports, "ESP32C2ROM", () => $e30dce9366113b8e$export$8ad31a2aa21b3abf);

var $lrSHl = parcelRequire("lrSHl");

var $hQf0T = parcelRequire("hQf0T");
class $e30dce9366113b8e$export$8ad31a2aa21b3abf extends (0, $lrSHl.ESP32C3ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($hQf0T))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($hQf0T))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($hQf0T))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($hQf0T))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($hQf0T))).text;
    }
...
parcelRegister("hQf0T", function(module, exports) {
...
//# sourceMappingURL=esp32c2.d6bc5af7.js.map

...
parcelRegister("385yJ", function(module, exports) {

$parcel$export(module.exports, "ESP32C6ROM", () => $24766e639363b09d$export$652353697ef98b38);

var $2JmMA = parcelRequire("2JmMA");

var $gpPuu = parcelRequire("gpPuu");
class $24766e639363b09d$export$652353697ef98b38 extends (0, $2JmMA.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($gpPuu))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($gpPuu))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($gpPuu))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($gpPuu))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($gpPuu))).text;
    }
...
parcelRegister("gpPuu", function(module, exports) {
...
//# sourceMappingURL=esp32c6.789b7c53.js.map

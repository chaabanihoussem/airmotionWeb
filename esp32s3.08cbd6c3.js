...
parcelRegister("8DQ91", function(module, exports) {

$parcel$export(module.exports, "ESP32S3ROM", () => $64aa6a106f5fd353$export$e18277a04821a5e);

var $2JmMA = parcelRequire("2JmMA");

var $bKslN = parcelRequire("bKslN");
class $64aa6a106f5fd353$export$e18277a04821a5e extends (0, $2JmMA.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($bKslN))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($bKslN))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($bKslN))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($bKslN))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($bKslN))).text;
    }
...
parcelRegister("bKslN", function(module, exports) {
...
//# sourceMappingURL=esp32s3.08cbd6c3.js.map

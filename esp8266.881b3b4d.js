...
parcelRegister("eNP02", function(module, exports) {

$parcel$export(module.exports, "ESP8266ROM", () => $ac6d33bfcf0d5c57$export$b7173f2d596cb720);

var $2JmMA = parcelRequire("2JmMA");

var $yruvg = parcelRequire("yruvg");
class $ac6d33bfcf0d5c57$export$b7173f2d596cb720 extends (0, $2JmMA.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($yruvg))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($yruvg))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($yruvg))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($yruvg))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($yruvg))).text;
...
parcelRegister("yruvg", function(module, exports) {
...
//# sourceMappingURL=esp8266.881b3b4d.js.map
